...
export default function CreateBundle() {
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "20px 4px" }}>
      ...
      <h1 className="font-display text-4xl text-paper" style={{ margin: "16px 0 6px" }}>Create Event Bundle</h1>
      <p style={{ color: "var(--muted)", marginBottom: 24 }}>Bundle multiple seatmap events scheduled at the same venue for a special seat price.</p>

      {error && <div className="rounded-lg bg-red-50 p-3 text-sm text-danger" style={{ marginBottom: 20 }}>{error}</div>}

      <form onSubmit={handleCreate} className="rounded-2xl bg-paper p-6 text-ink-text shadow-xl" style={{ display: "grid", gap: 20 }}>
        <div>
