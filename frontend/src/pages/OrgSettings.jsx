...
const OrgSettings = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      // If the slug changed, the URL this page lives at is now stale —
      // navigate to the new one so the address bar (and any bookmarks
      // going forward) match reality.
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="text-muted mb-8">Update your public details, or delete this organization.</p>
